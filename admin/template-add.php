                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-10">
                                                    <input v-model="page.info.uemail"
                                                           disabled="disabled" type="email" id="example-email"
                                                           name="example-email"
                                                           class="form-control"
                                                           placeholder="">
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-7">
                                                    <input v-model="page.info.upass"
                                                           disabled="disabled" type="password" class="form-control"
                                        ...
                                        <div class="col">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-10">
                                                    ...
                                                    <button onclick="updateinfo()" class="btn btn-secondary w-100">Add
                                                        New User
                                                    </button>
                                                </div>
                                            </div>
